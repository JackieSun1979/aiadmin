...
import type { DocumentsLimitResponse } from '@/models/common'
...
type Page = NotionPage & { workspace_id: string }
...
const StepOne = ({
  ...
  const { limitsData } = useState<DocumentsLimitResponse>({documents_count:5000,documents_limit:50});
